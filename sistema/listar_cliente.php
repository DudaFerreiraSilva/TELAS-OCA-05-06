...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="offcanvas-body">
            ...
            <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="listar_cliente.php">Cadastro de Cliente</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="listar_cliente.php">Relatório de Cliente</a>
            </li>
            </ul>
        </div>
        </div>
